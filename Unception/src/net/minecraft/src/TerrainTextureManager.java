...
public class TerrainTextureManager
{
    ...
    {
        World world = isoimagebuffer.level;
        if (world == null)
        {
        ...
        int i = isoimagebuffer.x * 16;
        int j = isoimagebuffer.y * 16;
        int k = i + 16;
        int l = j + 16;
        Chunk chunk = world.getChunkFromChunkCoords(isoimagebuffer.x, isoimagebuffer.y);
        if (chunk.isEmpty())
        {
            isoimagebuffer.noContent = true;
            isoimagebuffer.rendered = true;
        ...
        {
            isoimagebuffer.image = new BufferedImage(32, 544, 2);
        }
        isoimagebuffer.image.setRGB(0, 0, 32, 544, pixels, 0, 32);
        isoimagebuffer.rendered = true;
    }
